...
public final class PhoenixUtil {
  ...
  /**
   * Disables background processes managed by Phoenix, intended for competition use. Note that
   * Phoenix Tuner X will not be able to connect to the robot when this method is in use.
   */
  ...
  /**
   * Runs a Phoenix API call and checks for errors. Will try up to 3 times if the target API call
   * fails.
   *
