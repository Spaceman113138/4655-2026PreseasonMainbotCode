...
import frc.robot.util.vendors.RevUtil;
  ...
  private static void profiledPIDController() {
    Tunables.registerHandler(
        ...
        (table, pid) -> {
          ...
          table.value(
              "maxVelocity",
              pid.getConstraints().maxVelocity,
              v ->
                  pid.setConstraints(
                      new TrapezoidProfile.Constraints(v, pid.getConstraints().maxAcceleration)));
          table.value(
              "maxAcceleration",
              pid.getConstraints().maxAcceleration,
              v ->
                  pid.setConstraints(
                      new TrapezoidProfile.Constraints(pid.getConstraints().maxVelocity, v)));
        });
  }
  ...
  private static void sparkMax() {
    Tunables.registerHandler(
        ...
        (table, spark) -> {
          ...
          motionTable.value(
              "velocity",
              motionConfig.getMaxVelocity(slot),
              v -> {
                var newConfig = new SparkMaxConfig();
          ...
          motionTable.value(
              "acceleration",
              motionConfig.getMaxAcceleration(slot),
              v -> {
                var newConfig = new SparkMaxConfig();
          ...
          motionTable.value(
              ...
              motionConfig.getAllowedClosedLoopError(slot),
              v -> {
                var newConfig = new SparkMaxConfig();
  ...
  private static void talonFX() {
    Tunables.registerHandler(
        ...
        (table, talonFX) -> {
          ...
          motionTable.value(
              "velocity",
              motionConfig.MotionMagicCruiseVelocity,
              v -> {
                talonFX.getConfigurator().refresh(motionConfig);
          ...
          motionTable.value(
              "acceleration",
              motionConfig.MotionMagicAcceleration,
              v -> {
                talonFX.getConfigurator().refresh(motionConfig);
          ...
          motionTable.value(
              "expoKv",
              motionConfig.MotionMagicExpo_kV,
              v -> {
                talonFX.getConfigurator().refresh(motionConfig);
          ...
          motionTable.value(
              "expoKa",
              motionConfig.MotionMagicExpo_kA,
              v -> {
                talonFX.getConfigurator().refresh(motionConfig);
